...
public class GeometryTests
{
    ...
    public void TestWithinBounds()
    {
        ...
        Assert.IsFalse(Algorithms.WithinBounds(new Vector2(-0.1f, 0), min, max));
        Assert.IsFalse(Algorithms.WithinBounds(new Vector2(0, -0.1f), min, max));
        Assert.IsFalse(Algorithms.WithinBounds(new Vector2(1.1f, 0), min, max));
        Assert.IsFalse(Algorithms.WithinBounds(new Vector2(0, 1.1f), min, max));
    }
